...
| Ranged | Bow of Awareness (stat stick) |
...
| Chest | Yuan-ti Scale Mail → Armour of Agility (Act 3) |
| Gloves | Gloves of Archery → Legacy of the Masters (Act 3) |
...
### Ravaged Beach → Camp (Level 1-2)
- Recruit: Shadowheart, Astarion, Gale
- Dank Crypt: Awaken Withers (enables respec)
- Recruit Lae'zel nearby

### Emerald Grove (Level 2-3)
- Recruit Wyll (temporary — lost after grove raid)
- **DO NOT KILL THE STRANGE OX** in the stables. It must survive to Act 2.
- Buy Elixir of Hill Giant Strength from Auntie Ethel (stock up — buy several)
- [ ] **Broodmother's Revenge** → Astarion: From Kagha in druid sanctum (loot/steal)
- [ ] **Ring of Protection** → Minthara (later): Mol's quest reward (steal the idol)

### Blighted Village (Level 3)
- [ ] **Bracers of Defence** → Visara: Gilded chest in Apothecary's Cellar (X: -656 Y: -370)
- [ ] **Haste Helm** → Lae'zel: Locked wooden chest near waypoint

### Risen Road / Waukeen's Rest (Level 3-4)
- [ ] **The Spellsparkler** → Visara: Reward for rescuing Counsellor Florrick
- [ ] **Titanstring Bow** → Astarion: Zhentarim trader (Brem in Zhentarim Hideout)
...
- [ ] **The Shadespell Circlet** → Visara: Buy from Omeluum after quest
- [ ] **Boots of Stormy Clamour** → Visara: Buy from Omeluum after quest
- [ ] **Melf's First Staff** → Visara: From Omeluum shop (dual wield with Spellsparkler)
...
- [ ] **The Protecty Sparkswall** → Visara: Gilded chest behind trapped bridge (X: -645 Y: 360)
...
**End of Act 1 target: Level 6. Party: Shadowheart, Visara, Astarion, Lae'zel.**
...
- [ ] **Cloak of Protection** → Visara (temp until Cloak of the Weave in Act 3, then → Shadowheart)
- [ ] **Amulet of the Harpers** → Shadowheart: For emergency saves

> **!! CRITICAL: Kill the Strange Ox at the Last Light Inn stables.**
- [ ] **Hat of Fire Acuity** → Visara: **BUILD ENABLER.** Generates Arcane Acuity on Fire damage. Visara's build is NOW ONLINE.

### Shadow-Cursed Lands — Ruined Battlefield (Level 6-7)
- [ ] **Ring of Mental Inhibition** → Visara: Locked chest in House in Deep Shadows (X: 72 Y: 40)

### Reithwin Town — Three Bosses (Level 7)
Clear all three to weaken Ketheric:
1. **House of Healing** (Malus Thorm)
2. **Tollhouse / Mason's Guild** (Gerringothe Thorm)
   - [ ] **Helmet of Arcane Acuity** → Shadowheart: Locked gilded chest in Mason's Guild basement (X: 107 Y: -758). **CORE ITEM.**
3. **Waning Moon** (Thisobald Thorm)

### Moonrise Towers — First Visit (Level 7)
Infiltrate. Meet Z'rell, Ketheric.

- [ ] **Risky Ring** → Shadowheart: Buy from Roah Moonglow (use this now or lend to Visara for Act 2 if TB build needs it)
- [ ] **Spineshudder Amulet** → Visara: Mimic chest in Isobel's room (X: -171 Y: -195)
...
- [ ] **Halberd of Vigilance** → Shadowheart: Buy from Lann Tarv (upgrade to Unseen Menace if you have Risky Ring)
- Get **Potion of Everlasting Vigour** from Araj Oblodra → Shadowheart: **+2 STR** (STR now 20). Warning: causes Astarion relationship issues.

### Gauntlet of Shar (Level 7-8)
Complete three trials. Collect 4 Umbral Gems.

- [ ] **Callous Glow Ring** → Visara: Opulent chest in Balthazar's area (X: -819 Y: -753)
...
- **Immediate respec:** Oathbreaker 7 / White Draconic Sorcerer 5 (see minthara-leveling.md)
- **Transfer from Lae'zel:** Adamantine Splint Armour, Everburn Blade, Grymskull Helm
- **Elixir of Hill Giant Strength** on Minthara (21 STR until Gauntlets in Act 3)
- Lae'zel → camp

### Moonrise Towers Assault → Mind Flayer Colony (Level 8-9)
- Defeat Ketheric Thorm
- Clear the Mind Flayer Colony beneath

**End of Act 2 target: Level 8-9. Party: Shadowheart, Visara, Astarion, Minthara.**
...
- [ ] **Spellmight Gloves** → Visara: Pickpocket Lucretious at her tent

**Rivington shops:**
- [ ] **Hellrider Longbow** → Visara: Buy from Ferg Drogher (+3 initiative, equip at combat start for initiative then swap to staves)
...
- [ ] **Markoheshkir** → Visara: Pedestal puzzle with See Invisibility. **CORE ITEM.** +1 spell attack/DC, Arcane Battery, Flame of Wrath attunement.
- [ ] **Armour of Landfall** → Visara: Lorroakan's chambers. +1 DC, CON save advantage.

**Stormshore Tabernacle:**
- [ ] **Amulet of the Devout** → Shadowheart: Offering chest in basement treasury (X: 796 Y: 1159). +2 spell save DC.

**Stormshore Armoury:**
- [ ] **Armour of Agility** → Astarion: Buy from Gloomy Fentonson
...
- [ ] **Cloak of the Weave** → Visara: +1 spell save DC, +1 spell attack. Hand Cloak of Protection to Shadowheart.
...
- [ ] **Balduran's Giantslayer** → Minthara: Best greatsword (doubles STR modifier). With 23 STR gauntlets = +12 per hit.
- [ ] **Helm of Balduran** → Minthara: +1 AC, +1 saves, 2 HP/turn regen, immunity to stun + crits.

### House of Hope (Level 11-12)
...
### Iron Throne (Level 11-12)
Underwater prison. Time-limited rescue mission.

### Temple of Bhaal / Orin (Level 12)
- [ ] **Crimson Mischief** → (spare, or give to Astarion if he wants a dagger offhand)

### Mirror of Loss (Act 3 — Shar Temple area)
**Each character can get +2 to one stat:**
- Shadowheart: +2 STR → **22 STR final** (requires passing a difficult check — see guides for prep)
- Visara: +2 CHA → **19 CHA final** (or 20 if you adjusted starting stats)
- Astarion: +2 DEX → **21 DEX final**
- Minthara: +2 CHA → **18 CHA final**
...
| When | Choice | Reward |
|------|--------|--------|
| Act 1 | Don't kill Strange Ox at Grove | Preserves Hat of Fire Acuity for Act 2 |
| Act 1 | Hag's Hair → Shadowheart +1 STR | 18 STR |
| Act 1 | Raid the Emerald Grove (side with goblins) | Minthara as temp ally, permanent in Act 2 |
| Act 2 | Kill Strange Ox at Last Light Inn | Hat of Fire Acuity → Visara |
| Act 2 | Potion of Everlasting Vigour (Araj) | +2 STR → Shadowheart (20 STR) |
| Act 2 | Shadowheart kills Nightsong | Shar's Spear of Evening |
...
## Respec / Milestone Reminders

| When | Who | What |
|------|-----|------|
| Level 7 (end Act 1) | Shadowheart | Respec: 1 Paladin → 6 Swords Bard. Dump DEX. Get Heavy Armor prof. |
| Level 7 | Visara | Dip 1 Fiend Warlock. Get Command. |
| Minthara joins (Act 2) | Minthara | Full respec to OB Paladin 7 / Sorcerer 5 (at whatever level she joins) |
| Level 8 | Shadowheart | 2 Paladin done. Divine Smite ONLINE. |
| Level 12 | Shadowheart | Magical Secrets: Counterspell + Hunger of Hadar |
| Level 12 | Visara | Level 6 spell slot. Chain Lightning. Last metamagic: Careful. |
...
|-----------|---------|-------|
| Shadowheart | Elixir of Bloodlust | Elixir of Bloodlust |
| Visara | Elixir of Bloodlust | Elixir of Bloodlust |
| Astarion | Elixir of Bloodlust (with Club of Hill Giant STR) | Elixir of Cloud Giant STR (27 STR) or Bloodlust with Club |
| Lae'zel | Elixir of Hill Giant STR | — |
